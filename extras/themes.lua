...
return {
   ...
   Barbie = {
      Text = { 1.00, 1.00, 1.00, 1.00, },
      TextDisabled = { 0.80, 0.75, 0.85, 1.00, },
      WindowBg = { 0.95, 0.75, 0.90, 0.94, }, -- soft pink
      ChildBg = { 0.00, 0.00, 0.00, 0.00, },
      PopupBg = { 0.85, 0.55, 0.75, 0.94, },  -- vibrant magenta
      Border = { 0.70, 0.30, 0.60, 0.60, },
      BorderShadow = { 0.00, 0.00, 0.00, 0.00, },
      FrameBg = { 0.95, 0.60, 0.85, 0.54, },
      FrameBgHovered = { 1.00, 0.75, 0.90, 0.65, },
      FrameBgActive = { 0.85, 0.40, 0.75, 0.80, },
      TitleBg = { 0.85, 0.40, 0.75, 0.67, },
      TitleBgActive = { 0.85, 0.40, 0.75, 1.00, },
      TitleBgCollapsed = { 0.85, 0.40, 0.75, 0.67, },
      MenuBarBg = { 0.90, 0.50, 0.80, 1.00, },
      ScrollbarBg = { 0.10, 0.10, 0.10, 0.20, },
      ScrollbarGrab = { 0.90, 0.50, 0.80, 1.00, },
      ScrollbarGrabHovered = { 1.00, 0.60, 0.90, 1.00, },
      ScrollbarGrabActive = { 0.80, 0.20, 0.60, 1.00, },
      CheckMark = { 1.00, 1.00, 1.00, 1.00, },
      SliderGrab = { 1.00, 0.60, 0.90, 1.00, },
      SliderGrabActive = { 0.90, 0.30, 0.75, 1.00, },
      Button = { 0.90, 0.30, 0.70, 0.65, },
      ButtonHovered = { 1.00, 0.50, 0.85, 0.80, },
      ButtonActive = { 0.60, 0.10, 0.40, 0.90, },
      Header = { 0.90, 0.30, 0.70, 0.54, },
      HeaderHovered = { 1.00, 0.50, 0.85, 0.65, },
      HeaderActive = { 0.85, 0.40, 0.75, 0.80, },
      Separator = { 0.70, 0.20, 0.60, 0.60, },
      SeparatorHovered = { 1.00, 0.60, 0.90, 0.80, },
      SeparatorActive = { 0.90, 0.40, 0.70, 0.90, },
      ResizeGrip = { 0.90, 0.30, 0.70, 0.54, },
      ResizeGripHovered = { 1.00, 0.60, 0.90, 0.66, },
      ResizeGripActive = { 0.85, 0.20, 0.65, 0.80, },
      Tab = { 0.90, 0.30, 0.70, 0.54, },
      TabHovered = { 1.00, 0.60, 0.90, 0.80, },
      TabActive = { 0.90, 0.40, 0.75, 0.90, },
      TabUnfocused = { 0.60, 0.30, 0.50, 0.70, },
      TabUnfocusedActive = { 0.80, 0.40, 0.65, 0.80, },
      PlotLines = { 0.90, 0.40, 0.70, 1.00, },
      PlotLinesHovered = { 1.00, 0.70, 0.90, 1.00, },
      PlotHistogram = { 1.00, 0.60, 0.90, 1.00, },
      PlotHistogramHovered = { 1.00, 0.80, 1.00, 1.00, },
      TableHeaderBg = { 0.85, 0.40, 0.75, 1.00, },
      TableBorderStrong = { 0.80, 0.20, 0.70, 1.00, },
      TableBorderLight = { 0.90, 0.50, 0.85, 1.00, },
      TableRowBg = { 0.95, 0.75, 0.90, 0.30, },
      TableRowBgAlt = { 1.00, 0.85, 0.95, 0.40, },
      TextSelectedBg = { 1.00, 0.50, 0.90, 0.35, },
      DragDropTarget = { 1.00, 1.00, 0.00, 0.90, },
      NavHighlight = { 1.00, 0.60, 0.90, 0.70, },
      NavWindowingHighlight = { 1.00, 0.80, 1.00, 0.70, },
      NavWindowingDimBg = { 0.80, 0.60, 0.80, 0.20, },
      ModalWindowDimBg = { 0.90, 0.70, 0.90, 0.40, },
   },
}
